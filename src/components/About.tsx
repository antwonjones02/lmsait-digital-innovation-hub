      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            <span className="text-sm font-medium text-primary mb-3 block">About LMS & AI Technology</span>
            ...
            <p className="text-muted-foreground text-lg mb-8">
              <AnimatedText 
                text="At LMS & AI Technology, we combine educational expertise with cutting-edge technology to create learning solutions that truly engage and transform. Our approach centers on understanding your unique needs and delivering measurable results."
                delay={200}
                className="text-balance"
              />
            </p>
