...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="section bg-gradient-to-b from-slate-950 to-indigo-950/70 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className={`container-custom relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-blue-100/80 max-w-2xl mx-auto text-balance">
            Discover how our solutions have transformed learning experiences and driven success for organizations worldwide.
          </p>
        </div>
        
        <div className="max-w-4xl mx-auto">
          <div className="relative frosted-card rounded-2xl shadow-xl p-8 md:p-10 overflow-hidden">
            {/* Quote icon */}
            <div className="absolute top-6 right-6 text-indigo-100">
              <Quote size={120} className="opacity-10" />
            </div>
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-indigo-300">{testimonials[activeIndex].title}</div>
                    <div className="text-sm text-blue-200/70">{testimonials[activeIndex].company}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute top-1/2 left-0 right-0 flex justify-between items-center -translate-y-1/2 px-4">
              <button 
                ...
                className="bg-slate-800/80 hover:bg-slate-700/80 text-white p-2 rounded-full shadow-md backdrop-blur-sm transition-all"
        ...
        {/* Logos of clients */}
        <div className="mt-20">
          <p className="text-center text-sm uppercase tracking-wider text-blue-200/50 mb-8">Trusted by leading organizations</p>
      ...
      <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-indigo-950/70 to-transparent"></div>
    </section>
  );
};
